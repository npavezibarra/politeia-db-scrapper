"""
Fix Antofagasta data - re-scrape just this commune
"""
import asyncio
import json
from playwright.async_api import async_playwright

async def fix_antofagasta():
    ...
    async with async_playwright() as p:
        ...
        print("\n👉 Click on 'Antofagasta' in the sidebar")
        print("   Wait for data to load (5 seconds)")
        print("   Then press ENTER...")
        
        input()
        
        print("\nExtracting Antofagasta data...")
        ...
        # Load existing data
        try:
            with open('/Users/nicolas/Desktop/PoliteiaDB/II/region_ii_data.json', 'r') as f:
                data = json.load(f)
        except:
            data = []
        
        # Update or add Antofagasta
        found = False
        for commune in data:
            if commune['commune'] == 'Antofagasta':
        ...
        # Save
        with open('/Users/nicolas/Desktop/PoliteiaDB/II/region_ii_data.json', 'w', encoding='utf-8') as f:
            json.dump(data, f, indent=2, ensure_ascii=False)
        
        print("\n✓ Antofagasta data updated!")

if __name__ == "__main__":
    asyncio.run(fix_antofagasta())
